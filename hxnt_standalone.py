...
while True:
  while True:
    ...
    if len(key_id) != 0 and "/" in key_id: break
  ...
  while True:
    ...
    if len(key) != 0 and os.path.isfile(key): break
...
while True:
  while True:
    ...
    if len(hyperflex_cluster) != 0: break
    print("That answer is invalid.")
  try:
...
while True:
  while True:
    ...
    if len(smtp_server) != 0 and "." in smtp_server: break
    print("That answer is invalid")
...
while True:
  ...
  if len(notification_email) != 0 and "@" in notification_email: break
  print("That answer is invalid.")
